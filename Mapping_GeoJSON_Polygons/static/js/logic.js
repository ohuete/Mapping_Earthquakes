...
let torontoData = "https://raw.githubusercontent.com/ohuete/Mapping_Earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
//                     "</h2> <hr> <h3> Airport name: " + feature.properties.name + "," + feature.properties.country);
//     }
//         }).addTo(map);
//   }).addTo(map);
...
//                     "</h2> <hr> <h3>" + feature.properties.name + "," + feature.properties.country);
//     }
// }).addTo(map);

// // Grabbing GeoJSON data with onEachFeature Function
// L.geoJSON(sanFranAirport, {
//     onEachFeature: function(feature, layer) {
//     console.log(layer);
//       layer.bindPopup();
